...
(function(){
  ...
  function createDialogBox(node){
    ...
    document.getElementById("ordrinMenu").getElementsByClassName("optionContainer")[0].appendChild(node);
  ...
  function addTrayItem(){
    ...
    var item = dialog.getElementsByClassName("optionsTitle")[0].innerHTML
