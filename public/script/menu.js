(function(){
  ...
  function addTrayItem(){
    ...
    var category = document.getElementById("optionsDialog").getAttribute("data-category")
    
    check_boxes = document.getElementById("optionsDialog").getElementsByClassName("optionCheckbox")
